...
> Last updated: 2026-05-26 07:43:45 UTC
...
| `decile_contribution_bar.png` | 300 | 218 KB | Layer 1 supporting |
| `concentration_over_time.png` | 300 | 299 KB | Layer 1 conditional time-series |
...
| File | DPI | Size | Purpose |
|---|---|---|---|
| `decile_rar_ladder.png` | 300 | 206 KB | Layer 2 hero — embedded in README |
| `coefficient_chart.png` | 300 | 194 KB | Layer 2 model interpretability |
| `calibration_curve.png` | 300 | 219 KB | Layer 2 model trustworthiness |
| `roc_curve.png` | 300 | 200 KB | Layer 2 ROC supporting visual |
...
| 2026-05-26 | 2 | Added Layer 2 outputs section: 5 parquet tables, 4 figures, 2 new SQL files |
