...
| `outputs/tables/concentration_drivers.parquet` | `Layer 1 Task 6.7 — log decomposition` | 3 | 5 |
...
| `outputs/tables/model_coefficients.parquet` | `Layer 2 Task 7.3 — coefficient + bootstrap CI` | 8 | 9 |
| `outputs/tables/rar_per_household.parquet` | `Layer 2 Task 7.6 — RaR = P × E[GMV]` | 2,845 | 6 |
| `outputs/tables/rar_by_segment_with_ci.parquet` | `Layer 2 Task 7.7 — segment-level RaR + bootstrap` | 51 | 8 |
| `outputs/tables/category_taxonomy.json` | `Layer 3 Task 8.1 — Claude Opus 4.7 taxonomy` | 1,817 | — |
...
| `outputs/tables/category_scale_growth.parquet` | `Layer 3 Task 8.3 — scale + CAGR + bootstrap CI` | 12 | 13 |
...
| `sql/05_household_features.sql` | Layer 2: 8 features + R12 walk-forward leakage guard |
